...
# image1 = preprocess(Image.open("./1.png")).unsqueeze(0).to(device)
# image2 = preprocess(Image.open("./2.png")).unsqueeze(0).to(device)
#
# with torch.no_grad():
#     image_features1 = model.encode_image(image1)
#     image_features2 = model.encode_image(image2)
#
# loss = (image_features1 - image_features2).abs()
# print(loss)
